...
<section class="section mt-6 pt-6">
    ...
    <form action="/register" method="POST">
        ...
        <div class="field-body">
          <div class="field">
            ...
            <label class="label">{lat}
              <p class="control is-expanded has-icons-left">
                <input class="input" type="number" step="any" placeholder="Enter your location latitude" name="userLat">
          ...
          <div class="field">
            <label class="label">{long}
              <p class="control is-expanded has-icons-left">
                <input class="input" type="number" step="any" placeholder="Enter your location longitude" name="userLong">
      ...
      <!-- </datalist> -->
          ...
          <div class="field">
            <label class="label">{street}
              <p class="control is-expanded has-icons-left">
                <input class="input" type="text" placeholder="Enter your street" name="street">
          ...
          <div class="field">
            <label class="label">{addressCode}
              <p class="control is-expanded has-icons-left">
                <input class="input" type="text" placeholder="Enter your address code" name="addressCode">
      ...
      <div class="field is-horizontal">
        <div class="field-body">
          <div class="field">
            <label class="label">{DOB}
              <div class="control has-icons-left">
                <input class="input" type="date" id="date"  min="1930-01-01" max="2012-01-01" placeholder="Enter your date of birth" name="DOB" />
                <span class="icon is-small is-left">
          ...
          <div class="field">
            <label class="label">{phoneNumber}
              <div class="control has-icons-left">
                <input class="input" type="number" placeholder="Enter your phone number" name="phoneNumber" />
                <span class="icon is-small is-left">
      ...
      <div class = "column is-3 field is-grouped">
        <button class="button is-info has-text-white px-5">Submit</button>
        
        </div>
        
      
       <div class = "column is-9 mt-3 pr-4 ">
...
<section class="column is-4 p-4 pt-6">
  <div class="mt-6 pt-6 has-text-centered">
    <h2 class="subtitle is-4 mt-2 mt-4 ">Have a....</h2>
    <figure class="image is-264x264 m-auto p-2">
