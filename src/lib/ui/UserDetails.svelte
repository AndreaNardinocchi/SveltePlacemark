<script>
  let firstName = "John";  // Example data
  let lastName = "Doe";
      ...
      <div class="column is-6 is-size-5 box p-6">
        ...
        <div class="columns">
          ...
          <div class="column is-6 is-size-6">
            ...
            <hr />
            <p><span class="has-text-weight-bold">Coordinates (lat/long):</span><br /> {userLat}<br /> {userLong}</p>
            <hr />
          </div>
        </div>
        <div>
          <a class="button is-danger m-2" href={`/account/deleteuser/${_id}`} >
          Delete account
          </a>
          <button class="button is-light m-2" on:click={openModal}>
          Update account
          </button>
          {#if isModalOpen}
                      ...
                      <div class="field-body">
                        <div class="field">
                          <label class="label">
                            ...
                            <p class="control is-expanded has-icons-left">
                              <input class="input" type="text" step="any" placeholder="Enter your location latitude" name="userLat" bind:value={userLat} />
                        ...
                        <div class="field">
                          <label class="label">
                            ...
                            <p class="control is-expanded has-icons-left">
                              <input class="input" type="text" step="any" placeholder="Enter your location longitude" name="userLong" bind:value={userLong} />
                              <span class="icon is-small is-left">
                              <i class="fas fa-compass" aria-hidden="true"></i>
                              </span>
                            </p>
                        ...
                        <div class="field">
                          <label class="label">
                            ...
                            <div class="control has-icons-left">
                              <input class="input" type="tel" placeholder="Enter your phone number" name="phoneNumber" bind:value={phoneNumber} >
                              <span class="icon is-small is-left">
